...
Tarayıcınızda [http://localhost:3000](http://localhost:3000) adresine gidin. Başlatma kodu esnasında terminalde konsola yazdırılan varsayılan admin bilgileri (genellikle admin@example.com / admin123 şeklindedir) ile ilk girişinizi yapın.
...
| `SEED_ADMIN_EMAIL` | hayır | `admin@example.com` | `npm run seed` oluşturduğunda kurulacak ilk varsayılan admin hesabıdır. |
...
| --- | --- | --- |
| admin (Yönetici) | `admin@example.com` | `admin123` |
